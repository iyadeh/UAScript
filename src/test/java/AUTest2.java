...
public class AUTest2 {
    ...
    public void firstTry(){
        ...
        WebElement profileButton = driver.findElement(By.xpath("/html/body/nav/div/a[2]"));
        profileButton.click();
        
        String successText = driver.findElement(By.xpath("/html/body/div/h2")).getText();
        if(successText.equals("Profile Page")){
